...
export default function Home() {
  ...
  return (
    <div>
      ...
      <Carousel autoPlay
        ...
        width={"100%"}>
        <div>
          <img className=' h-screen' src="https://plus.unsplash.com/premium_photo-1683887034491-f58b4c4fca72?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"   />
        ...
        <div>
          <img className=' h-screen' src="https://images.unsplash.com/photo-1607237138185-eedd9c632b0b?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
    ...
    <img class='h-full w-full object-cover' src="https://images.unsplash.com/photo-1606761568499-6d2451b23c66?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
    <button class="absolute bottom-0 left-0 mb-4 ml-4 border hover:border-sky-600 duration-500 group cursor-pointer text-sky-50 overflow-hidden h-14 w-56 rounded-md bg-sky-800 p-2 flex justify-center items-center font-extrabold">
        <div class="absolute z-10 w-48 h-48 rounded-full group-hover:scale-150 transition-all duration-500 ease-in-out bg-sky-900 delay-150 group-hover:delay-75"></div>
        <div class="absolute z-10 w-40 h-40 rounded-full group-hover:scale-150 transition-all duration-500 ease-in-out bg-sky-800 delay-150 group-hover:delay-100"></div>
        <div class="absolute z-10 w-32 h-32 rounded-full group-hover:scale-150 transition-all duration-500 ease-in-out bg-sky-700 delay-150 group-hover:delay-150"></div>
  ...
  <div class="gradient-cards">
    <div class="card transition duration-500 ease-in-out transform hover:scale-105">
      <div class="container-card bg-green-box">
      <img width="80" height="80" src="https://img.icons8.com/dotty/80/40C057/networking-manager.png" alt="networking-manager"/>
    ...
    <div class="card transition duration-500 ease-in-out transform hover:scale-105">
      ...
      <img width="64" height="64" src="https://img.icons8.com/sf-black-filled/64/EBEBEB/engineering.png" alt="engineering"/>
    ...
    <div class="card transition duration-500 ease-in-out transform hover:scale-105">
      ...
      <img width="50" height="50" src="https://img.icons8.com/ios-filled/50/FAB005/student-male--v1.png" alt="student-male--v1"/>
    ...
    <div class="card transition duration-500 ease-in-out transform hover:scale-105">
      ...
      <img width="50" height="50" src="https://img.icons8.com/ios-filled/50/228BE6/university.png" alt="university"/>
        <p class="card-title">Get up to 11x Leverage</p>
        <p class="card-description">Hubbles capital-efficient 110% collateral ratio lets users leverage up to 11x on their deposits.</p>
      </div>
    </div>
  </div>
</div>
...
<a href='https://uiverse.io/alexmaracinaru/white-octopus-62'>   <button> Click
  </button></a> 
</div>
<div class="cardd">
  <div class="card-border-topp">
