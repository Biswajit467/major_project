...
const CollageInfo = () => {
  ...
  const filterData = (activeSection) => {
    switch (activeSection) {
      case "admins":
        setFilteredData(
          clginfo.filter((item) => item.category.toLowerCase() === "admin")
        );
        break;
      case "teachers":
        setFilteredData(
          clginfo.filter((item) => item.category.toLowerCase() === "lecture")
        );
        break;
      case "staffs":
        setFilteredData(
          clginfo.filter((item) => item.category.toLowerCase() === "staff")
        );
        break;
      default:
